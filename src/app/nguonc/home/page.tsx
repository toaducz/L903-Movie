...
function MovieListContent({ page }: Readonly<{ page: number }>) {
  ...
  return (
    <>
      {listMovie?.movies.length === 0 ? (
        ...
        <div className='grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 xl:grid-cols-5 gap-3 sm:gap-5 p-3 w-full px-24'>
